...
// // Download and build CloudEvent-based JSON schemas for event messages
...
//         {
//             // Configure AsyncAPI V2 document (code-first)
//             asyncApi
...
//         {
//             // Configure AsyncAPI V3 document (code-first)
//             asyncApi
//                 .WithTermsOfService(new Uri("https://www.websitepolicies.com/blog/sample-terms-service-template"))
...
// // Register explicit AsyncAPI V2 document (builder pattern)
...
// // Register explicit AsyncAPI V3 document (builder pattern)
// builder.Services.AddAsyncApiDocument(document => document
//     .UsingAsyncApiV3()
//     .WithTitle("Cloud Event API")
//     .WithVersion("1.0.0")
...
// // Register schema resolver for JSON schemas
